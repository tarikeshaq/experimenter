...
export enum NimbusExperimentTargetingConfigSlug {
  ...
  TARGETING_INFREQUENT_USER_URIS = "TARGETING_INFREQUENT_USER_URIS",
  TARGETING_CASUAL_USER_URIS = "TARGETING_CASUAL_USER_URIS",
  TARGETING_REGULAR_USER_URIS = "TARGETING_REGULAR_USER_URIS",
  TARGETING_INFREQUENT_USER_TELEMETRY = "TARGETING_INFREQUENT_USER_TELEMETRY",
  TARGETING_CASUAL_USER_TELEMETRY = "TARGETING_CASUAL_USER_TELEMETRY",
  TARGETING_REGULAR_USER_TELEMETRY = "TARGETING_REGULAR_USER_TELEMETRY",
}
